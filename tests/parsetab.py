...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','ply_example.py',55),
  ('statement -> expression','statement',1,'p_statement_expr','ply_example.py',59),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','ply_example.py',63),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','ply_example.py',64),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','ply_example.py',65),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','ply_example.py',66),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','ply_example.py',73),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','ply_example.py',77),
  ('expression -> NUMBER','expression',1,'p_expression_number','ply_example.py',81),
  ('expression -> NAME','expression',1,'p_expression_name','ply_example.py',85),
]
